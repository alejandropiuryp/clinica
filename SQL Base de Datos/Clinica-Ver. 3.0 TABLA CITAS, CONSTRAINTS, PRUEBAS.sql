...
***********************************************************************************/
CREATE OR REPLACE PROCEDURE RangoCitasFecha(w_fecha_inicio DATE, w_fecha_fin DATE)               ----(Compila, revisar si es lo que queremos)
IS
    w_fecha citas.fecha%TYPE; 
    w_hora  citas.hora%TYPE; 
...
BEGIN 
    SELECT fecha, hora, tipo_cita, dni INTO w_fecha, w_hora, w_tipo, w_dni FROM CITAS NATURAL JOIN CLIENTES WHERE fecha BETWEEN w_fecha_inicio AND w_fecha_fin;
    COMMIT;
END;
/
...
---------------------------------------------------------------------------INSERTAR
    BEGIN
        PRUEBAS_CLIENTES.INSERTAR('INSERTA CLIENTE','48123737D','Pablo','Gómez Pérez',21,'C/La Palma',661152858,2702387129, '39770763xX',date'1999-06-06','pablo@gmail.com',TRUE);
        PRUEBAS_CLIENTES.INSERTAR('INSERTA CLIENTE','28123237D','Carlos','García Vázquez',21,'C/Pablo Rada',690382113,3704687129, '49958021Cc',date'1999-02-01', 'algar@gmail.com', TRUE);
        ...
        PRUEBAS_CITAS.INSERTAR('INSERTAR CITA', date '2020-06-21','18:00',2,'48123737D',1,TRUE);
        PRUEBAS_CITAS.INSERTAR('INSERTAR CITA', date '2020-06-19','19:00',2,'28123237D',4,TRUE);
